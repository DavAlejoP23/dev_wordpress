...
<?php 
        ...
        $button_section_resume_title = $button_section_resume['title'];
        $button_section_resume_target = $button_section_resume['target'];
?>
...
<section class="section-resume">
    <div class="container container-resume">
        ...
        <div class="container-btn">
            <a class="deep-purple-button" href="<?php echo esc_url($button_section_resume_url); ?>" target="<?php echo esc_attr($button_section_resume_target); ?>"> <?php echo esc_html($button_section_resume_title); ?> </a>
        </div>
    </div>
</section>